...
async function main() {
  ...
  await db.insert(workProjects).values([
    { slug: "01", title: "Empire Brand Relaunch", client: "Apex Corp", category: "Digital Marketing", year: "2024", outcome: "+187% organic reach in 90 days", bg: "#111111", accentColor: "#E50019", textLight: true, sortOrder: 1 },
    { slug: "02", title: "Executive Portrait Series", client: "Meridian Group", category: "Photo Production", year: "2024", outcome: "120-image brand library delivered", bg: "#E50019", accentColor: "#0A0A0A", textLight: true, sortOrder: 2 },
    { slug: "03", title: "Product Launch Film", client: "Nova Brands", category: "Video Production", year: "2023", outcome: "2.4M views in the first week", bg: "#EBEBEB", accentColor: "#E50019", textLight: false, sortOrder: 3 },
    { slug: "04", title: "Industry News Editorial", client: "Sterling Media", category: "News & Media", year: "2024", outcome: "Featured in 40+ publications", bg: "#0F0F0F", accentColor: "#E50019", textLight: true, sortOrder: 4 },
    { slug: "05", title: "Social Dominance Campaign", client: "Vanta Group", category: "Digital Marketing", year: "2024", outcome: "#1 trending campaign — 3 weeks", bg: "#1A0808", accentColor: "#E50019", textLight: true, sortOrder: 5 },
    { slug: "06", title: "CEO Brand Identity Shoot", client: "Crest Digital", category: "Photo Production", year: "2023", outcome: "Full identity system deployed", bg: "#1C1C1C", accentColor: "#E50019", textLight: true, sortOrder: 6 },
    { slug: "07", title: "Corporate Vision Film", client: "Luminary Co.", category: "Video Production", year: "2024", outcome: "Screened at 3 industry events", bg: "#0A0A14", accentColor: "#E50019", textLight: true, sortOrder: 7 },
    { slug: "08", title: "Media Strategy Rollout", client: "Orbit Media", category: "News & Media", year: "2023", outcome: "300% growth in press coverage", bg: "#E50019", accentColor: "#F5F5F5", textLight: true, sortOrder: 8 },
    { slug: "09", title: "E-Commerce Relaunch", client: "Prism Studios", category: "Digital Marketing", year: "2024", outcome: "4.2× ROAS across all channels", bg: "#EBEBEB", accentColor: "#E50019", textLight: false, sortOrder: 9 },
    { slug: "10", title: "Lifestyle Photo Collection", client: "Nexus", category: "Photo Production", year: "2023", outcome: "Campaign ran across 6 markets", bg: "#141414", accentColor: "#E50019", textLight: true, sortOrder: 10 },
    { slug: "11", title: "AI Brand Commercial", client: "Velour Studios", category: "AI Video Creation", year: "2025", outcome: "1.8M impressions in first 48 hrs", bg: "#0A0014", accentColor: "#E50019", textLight: true, sortOrder: 11 },
    { slug: "12", title: "AI Product Campaign", client: "Luxe Goods Co.", category: "AI Video Creation", year: "2025", outcome: "3× conversion vs. traditional ads", bg: "#E50019", accentColor: "#F5F5F5", textLight: true, sortOrder: 12 },
    { slug: "13", title: "Luxury Product Imagery", client: "Auric Brand", category: "AI Image Generation", year: "2025", outcome: "60-image library — 3-day turnaround", bg: "#111108", accentColor: "#E50019", textLight: true, sortOrder: 13 },
    { slug: "14", title: "Billboard Campaign Visuals", client: "Pinnacle Retail", category: "AI Image Generation", year: "2025", outcome: "Deployed across 12 OOH placements", bg: "#EBEBEB", accentColor: "#E50019", textLight: false, sortOrder: 14 },
    { slug: "15", title: "Viral Ad Script Series", client: "Momentum Brand", category: "Script Writing", year: "2025", outcome: "4 hooks hit 500K+ views each", bg: "#0F0A0A", accentColor: "#E50019", textLight: true, sortOrder: 15 },
    { slug: "16", title: "Brand Storytelling Campaign", client: "Crest Media", category: "Script Writing", year: "2025", outcome: "42% lift in brand recall", bg: "#1A1A0A", accentColor: "#E50019", textLight: true, sortOrder: 16 },
  ]);
