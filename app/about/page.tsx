  ...
  return (
    <main className="bg-brand-black pt-16">
      ...
      <section className="relative border-b border-white/5 py-24 lg:py-36 overflow-hidden">
        ...
        {/* Watermark */}
        <span
          className="font-display absolute top-0 right-0 leading-none text-white/[0.025] pointer-events-none select-none uppercase translate-x-8"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-start">
            ...
            <div className="lg:sticky lg:top-32">
              ...
              {/* Visual accent */}
              <div className="mt-12 border border-white/7 p-6 relative">
                ...
                <p className="text-red text-[10px] tracking-[0.25em] uppercase mt-4">
                  — diEntertainment
                </p>
              </div>
            </div>
            ...
            <div className="space-y-7">
              ...
              <p className="text-brand-white/45 leading-relaxed">
              ...
              <div className="pt-4">
                ...
                >
                  Work With Us <span className="text-sm">→</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#0D0D0D] py-24 lg:py-32 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5">
            {values.map((v) => (
              <div key={v.number} className="service-card bg-[#0D0D0D] p-8 lg:p-10 group">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-center">
            <div>
              ...
              <h2
                className="font-display uppercase leading-[0.88] text-brand-white mb-8"
                style={{ fontSize: "clamp(44px, 6vw, 92px)" }}
              >
                Seven services.
                <br />
              ...
              <p className="text-brand-white/45 leading-relaxed max-w-sm">
              ...
              <a
                href="/#services"
                className="inline-flex items-center gap-2 mt-8 text-red text-[11px] tracking-[0.25em] uppercase hover:gap-4 transition-all duration-300"
              >
            ...
            <div className="grid grid-cols-1 gap-px bg-white/5">
              {services.map((s, i) => (
                <div
                  key={s}
                  className="bg-brand-black px-8 py-5 flex items-center justify-between group hover:bg-white/[0.02] transition-colors duration-200 cursor-default"
                >
                  <div className="flex items-center gap-5">
                    <span className="text-red/35 text-[9px] tracking-[0.3em] font-display">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <span
                      className="font-display text-brand-white/70 uppercase group-hover:text-brand-white transition-colors duration-200"
                      style={{ fontSize: "clamp(16px, 1.8vw, 22px)" }}
                    >
                      {s}
                    </span>
                  </div>
                  <span className="text-red/0 group-hover:text-red/60 text-sm transition-colors duration-200">→</span>
                </div>
              ))}
            </div>
          </div>
